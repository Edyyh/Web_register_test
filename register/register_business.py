...
class RegisterBusiness(object):
    ...
    # 模拟用户操作
    def register_base(self, email, name, password, code):
    ...
    # 输入用户名错误
    def register_username_error(self, email, name, password, code):
        self.register_base(email, name, password, code)
